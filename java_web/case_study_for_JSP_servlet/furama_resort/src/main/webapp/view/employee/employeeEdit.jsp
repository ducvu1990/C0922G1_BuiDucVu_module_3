    ...
    <div class="col-md-11 vh-100">
        ...
        <form action="/Customers?action=edit" method="post">
            <table class="table">
                ...
                <tr>
                    <th scope="col">ID</th>
                    <td><input type="text" name="id" value="${customers.getId()}"></td>
                </tr>
                <tr>
                    <th scope="col">Name</th>
                    <td><input type="text" name="name" value="${customers.getName()}"></td>
                </tr>
                <tr>
                    <th scope="col">Birthday</th>
                    <td><input type="text" name="birthday" value="${customers.getBirthday()}"></td>
                </tr>
                <tr>
                    <th scope="col">Gender</th>
                    <td>
                        <select name="gender" id="gender" value="${customers.isGender()}">
                            <c:choose>
                                <c:when test="${customers.isGender() == true}">
                ...
                <tr>
                    ...
                    <td><input type="text" name="idCard" value="${customers.getIdCard()}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="customerType" value="${customers.getCustomerType().getNameType()}">
