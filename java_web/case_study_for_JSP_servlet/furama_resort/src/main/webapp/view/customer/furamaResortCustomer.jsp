...
<div class="row bg-info">
  ...
  <div class="col-md-6 justify-content-center align-items-center d-flex">
    <h1 class="text-white" style="font-family: Playfair Display">Customer</h1>
  </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
            ...
            <%--Employee button--%>
            <li class="nav-item">
              <a class="nav-link active text-white" aria-current="page" href="#">List of customers</a>
            </li>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link text-white" href="#">Edit customers</a>
            </li>
            <li class="nav-link active text-white" aria-current="page">|</li>

            <%--Contrac button--%>
            <li class="nav-item">
              <a class="nav-link text-white" href="#">Modal delete customers</a>
            </li>
          </ul>
