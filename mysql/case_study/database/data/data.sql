...
values("QUẢN LÝ"),("NHÂN VIÊN");

insert into trinh_do(ten_trinh_do)
values ("TRUNG CẤP"),("CAO ĐẲNG"),("ĐẠI HỌC"),("SAU ĐẠI HỌC");

insert into bo_phan(ten_bo_phan)
values("SALE-MARKETING"),("HÀNH CHÍNH"),("PHỤC VỤ"),("QUẢN LÝ");

insert into nhan_vien(ho_ten,ngay_sinh,so_cmnd,luong,so_dien_thoai,email,dia_chi,ma_vi_tri,ma_trinh_do,ma_bo_phan)
values("NGUYỄN VĂN AN","1970-11-07","4562317861",10000000,"0901234121","ANNGUYEN@GAMIL.COM","295 NGUYỄN TẤT THÀNH, ĐÀ NẴNG",1,3,1),
...
insert into dich_vu(ten_dich_vu,dien_tich,chi_phi_thue,so_nguoi_toi_da,tieu_chuan_phong,mo_ta_tien_nghi_khac,dien_tich_ho_boi,
